		...
		<div class="card mb-3">
			...
			<div class="card-body">
				<table class="table table-responsive-xl table-striped">
					...
					<?php
					$i = 0;
					foreach ($brick_categorys as $row):
						$i++;
						?>
						<tr>
							...
							<td>
								<a href="<?php echo base_url(); ?>brick_categorys/edit/<?php echo $row['id']; ?>">
									<i class="fa fa-pencil-square-o bigfonts" aria-hidden="true"></i>&nbsp;
								</a>
								<a onclick="return deleteConfirm()"
								   href="<?php echo base_url(); ?>brick_categorys/delete/<?php echo $row['id']; ?>">
